	...
	* **/
	...
	public function fetchGalleryPhotos($params, $db, $check_only = false)
	{
		...
		else
		{
			...
			node.description, node.contenttypeid, node.publishdate, parent.nodeid AS parentnode, parent.title AS parenttitle, parent.authorname, parent.routeid, parent.userid, parent.setfor AS parentsetfor, starter.title AS startertitle
			FROM " . TABLE_PREFIX . "node AS node

...
define('FILE_VERSION', '5.0.1'); // this should match installsteps.php
if (!defined('SIMPLE_VERSION')) define('SIMPLE_VERSION', '501'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 73440 $
* @date		$Date: 2013-03-29 11:13:28 -0700 (Fri, 29 Mar 2013) $
*/

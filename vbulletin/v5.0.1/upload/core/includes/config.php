...
$config['Database']['dbname'] = 'imagine_world';
...
$config['Misc']['forumpath'] = '/opt/lampp/htdocs/forum/upload';
...
$config['Misc']['baseurl'] = 'http://localhost/forum/upload';

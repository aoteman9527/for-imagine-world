...
//		return vB_Types::instance()->getContentTypeTitle($this->get_contenttypeid());
	...
	*/
	...
	protected $form_globals = array (
		...
		'exactname'      => vB_Cleaner::TYPE_BOOL,
		'titleonly'		  => vB_Cleaner::TYPE_BOOL,
		'searchdate'	  => vB_Cleaner::TYPE_NOHTML,
		'beforeafter'	  => vB_Cleaner::TYPE_NOHTML,
		'contenttypeid'  => vB_Cleaner::TYPE_UINT,
		'ajax'           => vB_Cleaner::TYPE_BOOL,
		'tag'            => vB_Cleaner::TYPE_STR,
		'type'           => vB_Cleaner::TYPE_ARRAY,
		'humanverify'    => vB_Cleaner::TYPE_ARRAY,
		'sortby'         => vB_Cleaner::TYPE_NOHTML,
		'order'          => vB_Cleaner::TYPE_NOHTML,
		'sortorder'      => vB_Cleaner::TYPE_NOHTML,
		'saveprefs'      => vB_Cleaner::TYPE_BOOL,
		'quicksearch'    => vB_Cleaner::TYPE_BOOL,
		'search_type'    => vB_Cleaner::TYPE_BOOL,
		'searchfromtype' => vB_Cleaner::TYPE_STR,
		'showposts'      => vB_Cleaner::TYPE_UINT,
		'userid'         => vB_Cleaner::TYPE_UINT,
		'starteronly'    => vB_Cleaner::TYPE_UINT,
		'nocache'        => vB_Cleaner::TYPE_BOOL,
		'natural'        => vB_Cleaner::TYPE_BOOL
	);

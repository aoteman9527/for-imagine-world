...
class vB_Search_Core
{
  ...
  // const TYPE_SOCIAL_GROUP = 'SocialGroup';
	...
	*/
	...
	public static function get_instance()
	{
		if (is_null(self::$instance))
		{
			...
			if (!empty($searchimplementation))
			{
				call_user_func(array($searchimplementation, 'init'));
			}
	...
	*/
	 ...
	 * must register a controller for vB_Cleaner::TYPE_COMMON which should return results for all indexed

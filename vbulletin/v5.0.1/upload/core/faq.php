...
if ($_REQUEST['do'] == 'search')
{
	$vbulletin->input->clean_array_gpc('r', array(
		'q'            => vB_Cleaner::TYPE_STR,
		'match'        => vB_Cleaner::TYPE_STR,
		'titleandtext' => vB_Cleaner::TYPE_BOOL
	));
	...
	$phrases = $vbulletin->db->query_read_slave($query);
	...
	foreach ($search AS $word)
	{
		...
		$whereText[] = "text LIKE('%" . $vbulletin->db->escape_string_like($word) . "%')";
	}
	...
	// Legacy Hook 'faq_search_query' Removed //
	...
	// construct navbits
	$navbits = array(
		'faq.php' . vB::getCurrentSession()->get('sessionurl_q') => $vbphrase['faq'],
...
if ($_REQUEST['do'] == 'main')
{
	...
	{
		$navbits['faq.php' . vB::getCurrentSession()->get('sessionurl_q')] = $vbphrase['faq'];
	}
	...
	{
		eval(standard_error(fetch_error('invalidid', $vbphrase['faq_item'])));
	}
...
// Legacy Hook 'faq_complete' Removed //

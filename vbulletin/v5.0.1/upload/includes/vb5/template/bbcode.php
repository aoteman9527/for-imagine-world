...
*
* @package 		vBulletin
* @version		$Revision: 72031 $
* @date 		$Date: 2013-02-22 09:53:29 -0800 (Fri, 22 Feb 2013) $
*
*/
...
//		global $vbphrase, $show;
		...
		return vB5_Template_Runtime::includeTemplate(
				($this->printable ? 'bbcode_php_printable' : 'bbcode_php'),
				array(
...
//						}
						...
						$imgbits = array(
							...
							'border' => '0',
							'alt'    => $alt_text ? $alt_text : vB5_Template_Phrase::instance()->register('image_larger_version_x_y_z', $attachment['filename'], $attachment['counter'], $attachment['filesize'], $attachment['filedataid'])
						);
					...
					{	// Display the attachment with no link to bigger image
						...
						. vB5_Template_Phrase::instance()->register('image_x_y_z', $attachment['filename'], $attachment['counter'], $attachment['filesize'])
		...
		{	// Belongs to another post so we know nothing about it ... or we are not displying images so always show a link
			return "<a href=\"" . self::$config->baseurl . "/filedata/fetch?filedataid=$attachmentid\">" . vB5_Template_Phrase::instance()->register('attachment') . " </a>";
		}
	}
